...
if __name__ == "__main__":
     ...
     # win.frame_40.setStyleSheet("border-color:#9E9E9E")
     # win.frame_20.setStyleSheet("border-color:#9E9E9E")
     win.frame_17.setStyleSheet("border-color:#7B1FA2")
     win.frame_18.setStyleSheet("border-color:#7B1FA2")
     win.frame_19.setStyleSheet("border-color:#7B1FA2")
     win.frame_23.setStyleSheet("border-color:#7B1FA2")
     win.frame_22.setStyleSheet("border-color:#7B1FA2")
     win.frame_21.setStyleSheet("border-color:#7B1FA2")
     ...
     win.frame_27.setStyleSheet("border-color:#7B1FA2")
